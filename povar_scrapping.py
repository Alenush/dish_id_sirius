...
driver = Chrome(executable_path="/path/to/your/driver/chromedriver.exe")
...
MIN_CATEGS = 0
MAX_CATEGS = 271
DIR_NAME = '/path/to/dir/to/save/files/'
...
def main():
    ...
    for categ_num in range(MIN_CATEGS, MAX_CATEGS):
        ...
        # На одной странице максимум 40 рецептов, а на вторую страницу переходить так лень...
        for recipe_num in range(min(num_recipes, 40)):
            ...
            inds.append(f'{categ_num}_{recipe_num}')
            titles.append(title)
