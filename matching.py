...
def prepare_dataset(df):
    ...
    df['not_ingridients'] = df.nor_ingridients.apply(lambda x: create_text_for_vectorizer(x))
...
if __name__ == '__main__':
    ...
    final_best_matches = pd.DataFrame(best_matches.names.tolist(), index=best_matches.index)
